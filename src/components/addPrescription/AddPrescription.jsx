...
<div
    ...
    >
     ...
     {state.prescriptionInfo.map((contact, index) => (
            <>
            <div key={index} className="bg-slate-200 border p-3 rounded-xl m-3 ">
        <div className="grid grid-cols-2">
          <div className="col-span-2">
            <div className="w-3/4 mr-4 mt-3">
              ...
              <CustomTextField
                ...
                type="text"
                onChange={(val) => {
                    state.updateContactInfo(index, { prescriptionName: val.target.value });
                  }}
              />
            </div>
          </div>
          ...
          <div className="mr-3 mt-2">
            <DatePickerr contact={contact} label={"تاريخ  بدء اخذ الدواء"} index={index} />
          </div>
          <div className="mr-3 mt-2">
            <DatePickerr contact={contact} label={"تاريخ نهاية اخذ الدواء"} index={index} />
          </div>
          ...
          <div className="w-3/4 mr-4 mt-3">
            ...
            <CustomTextField
              ...
              type="text"
              onChange={(val) => {
                state.updateContactInfo(index, { note: val.target.value });
              }}
            />
          </div>
        </div>
