...
function TimeCenter({ data ,SettingTime, setSettingTime }) {
  console.log(data);
    ...
    <>
      ...
      />
        ...
        <div className="flex flex-wrap -mx-2">
          {data.map((card, index) => {
            const shiftStartFormatted = convertTo12HourFormat(
              new Date(card.shiftStart)
            );
            const shiftEndFormatted = convertTo12HourFormat(
              new Date(card.shiftEnd)
            );
            ...
            return (
              ...
              >
                ...
                <h3 className="text-right">
                  {shiftStartFormatted} إلى {shiftEndFormatted}
                </h3>
              </div>
            );
          })}
