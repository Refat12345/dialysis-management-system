    ...
    <div dir="rtl">
        <form>
            ...
            <div className='flex flex-row justify-center'>
                {!isLoading ? <button type="submit" onClick = {postData} className='my-4 font-primaryBold bg-bgButtonColor text-white hover:bg-bgSideButton hover:text-titleSideColor py-1 px-3 rounded-lg '
                > {"تأكيد"}
                </button>:
                <ButtonLoader/>}
