...
const MainLayout = () => {
    ...
    user.role === "secretary" ?sideBarData.header.title = `سكرتيرة مركز ${user.centerName}` : (user.role === "admin" ?sideBarData.header.title = `مدير مركز ${user.centerName}` : sideBarData.header.title)
return (
    <>
