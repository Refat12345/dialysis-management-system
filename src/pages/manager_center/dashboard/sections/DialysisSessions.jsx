...
const DialysisSessions = ({data}) => {
  ...
  let minHeight = height > 600 ? ( height > 735 ? ( height > 830 ? "min-h-customAbove830" : "min-h-customUnder830" ) : (height > 680 ? "min-h-customUnder735" : (height > 618 ? "min-h-customUnder680" : "min-h-customUnder618") ) ) : "min-h-customUnder600";
  let responsive = height > 700 ? "mb-6" : ( height < 628 ? ( height < 600 ? "mb-5" : "mb-2" ) : "mb-4" )
