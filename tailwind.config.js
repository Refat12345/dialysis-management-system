  ...
  theme: {
    extend: {
      ...
      minHeight: {
        ...
        // AuditAbove630:"434px",
        // AuditUnder630:"385px"
        customUnder600: "392px",
        customUnder618:"446px",
        customUnder680: "462px",
        customUnder735: "499px",
        customUnder830: "523px",
        customAbove830: "589px",
        centerAbove700:"616px",
        centerAbove700_1400:"637px",
        centerUnder700:"576px",
        centerUnder630:"559px",
        AuditAbove800:"657px",
        AuditAbove740:"602px",
        AuditAbove700:"560px",
        AuditAbove630:"511px",
